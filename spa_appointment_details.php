...
$select_customer = "SELECT fname, phone_no FROM customer_details WHERE customer_id='$customer_id'";
...
if ($result_customer && mysqli_num_rows($result_customer) > 0) {
    ...
    $phone_number = mysqli_real_escape_string($link, $row_customer['phone_no']);
} else {

	...
	<html>
		...
		<body>
			<form>
				...
				<input type="button" onclick="adddoctor()" value="Add"></input><br>
				<label>Delete a doctor:</label>
				<input type="button" onclick="deletedoctor()" value="Delete"></input><br>
				<label>Modify doctor details:</label>
				<input type="button" onclick="modifydoctor()" value="Modify"></input><br>
				</center>
			</form>
		</body>
		...
		<script>
			...
			function modifydoctor(){
				window.location.href="modifydoctor.php";
			}
		</script>
	</html>

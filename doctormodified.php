...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	echo '<body><form action="updated_doctor_details.php" method="POST">';

	echo '<h2>Update Doctor</h2><input type="hidden" name="doctor_id" value="' . $doctor_id . '">';
	...
	echo '<label>Enter Age:</label><input type="number" name="age"><br>';
	echo '<label>Enter Type:</label><input type="text" name="type"></input><br>';
	echo '<label>Enter Specialization:</label><input type="text" name="specialization"></input><br>';
